...
eval("module.exports = __webpack_require__.p + \"be47cbcd9b273ce4ac27.jpeg\";\n\n//# sourceURL=webpack://webpackk/./dist/img_1.jpeg?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_dom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/dom */ \"./src/modules/dom.js\");\n/* harmony import */ var _modules_parsejson__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/parsejson */ \"./src/modules/parsejson.js\");\n\n\n\n\nconst apiKey = '06d4a40aeec62ece3ab14b5fc03c4ec0';\n_modules_dom__WEBPACK_IMPORTED_MODULE_1__.searchForm.addEventListener('submit', event => {\n  event.preventDefault();\n  const currentCity = _modules_dom__WEBPACK_IMPORTED_MODULE_1__.checkCity.value;\n  const fetchWeather = async (city, unit) => {\n    const response = await fetch(\n      `https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=${apiKey}&units=${unit}`,\n    );\n    return response.json();\n  };\n\n  Promise.all([\n    fetchWeather(currentCity, 'metric'),\n    fetchWeather(currentCity, 'imperial'),\n  ])\n    .then(([celsiusData, FahrenheitData]) => {\n      (0,_modules_dom__WEBPACK_IMPORTED_MODULE_1__.default)((0,_modules_parsejson__WEBPACK_IMPORTED_MODULE_2__.default)(celsiusData), (0,_modules_parsejson__WEBPACK_IMPORTED_MODULE_2__.default)(FahrenheitData).temp);\n    })\n    .catch(() => {\n      _modules_dom__WEBPACK_IMPORTED_MODULE_1__.errorMessage.textContent = \"I Couldn't fetch weather for this city 😩.\";\n    });\n  _modules_dom__WEBPACK_IMPORTED_MODULE_1__.errorMessage.textContent = '';\n  _modules_dom__WEBPACK_IMPORTED_MODULE_1__.searchForm.reset();\n  _modules_dom__WEBPACK_IMPORTED_MODULE_1__.checkCity.focus();\n  (0,_modules_dom__WEBPACK_IMPORTED_MODULE_1__.selectImage)(currentCity);\n});\n\n\n//# sourceURL=webpack://webpackk/./src/index.js?");
